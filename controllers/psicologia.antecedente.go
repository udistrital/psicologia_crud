...
type PsicologiaAntecedenteController struct {
	beego.Controller
}

// URLMapping ...
func (c *PsicologiaAntecedenteController) URLMapping() {
...
// @Param	body		body 	models.PsicologiaAntecedente	true		"Cuerpo para el contenido de PsicologiaAntecedente"
// @Success 201 {int} models.PsicologiaAntecedente
// @Failure 403 Cuerpo Vacío
// @router / [post]
func (c *PsicologiaAntecedenteController) Post() {
	var v models.PsicologiaAntecedente
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		if _, err := models.AddPsicologiaAntecedente(&v); err == nil {
...
// @Success 200 {object} models.PsicologiaAntecedente
// @Failure 403 :id está vacío
// @router /:id [get]
func (c *PsicologiaAntecedenteController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := models.GetPsicologiaAntecedenteById(id)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = v
...
// @Failure 403
// @router / [get]
func (c *PsicologiaAntecedenteController) GetAll() {
	var fields []string
	var sortby []string
	var order []string
	...
	l, err := models.GetAllPsicologiaAntecedente(query, fields, sortby, order, offset, limit)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @router /:id [put]
func (c *PsicologiaAntecedenteController) Put() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v := models.PsicologiaAntecedente{IdPsicologiaAntecedente: id}
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
...
// @router /:id [delete]
func (c *PsicologiaAntecedenteController) Delete() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	if err := models.DeletePsicologiaAntecedente(id); err == nil {
		c.Data["json"] = "OK"
	} else {
		c.Data["json"] = err.Error()
	}
